...
constexpr TriggerRegistration MigratedDescriptors[]{
    ...
    {"minecraft:bred_animals", compileBredAnimalsCondition, matchesBredAnimalsCondition},
    ...
    {"minecraft:thrown_item_picked_up_by_player", compileAllayDeliveredItemCondition, matchesEntityCondition},
    {"minecraft:thrown_item_picked_up_by_entity", compilePiglinAdmireItemCondition, matchesPiglinAdmireItemCondition},
